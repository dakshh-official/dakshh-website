...
const TeamsTab = () => {
  ...
  const updateTeamName = async (teamId: string) => {
    try {
      ...
      const response = await fetch(
        `/api/registration/my-teams/update/${teamId}`,
        {
          method: "PATCH",
          headers: {
  ...
  const executeRemoveMember = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/registration/my-teams/remove-members/${teamId}`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
  ...
  const getTeamSize = (team: Team) =>
    team.teamSize ?? team.members?.length ?? team.team.length;
    ...
    <>
      <HandDrawnCard className="w-full space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-300 hand-drawn-text">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-12 space-y-4">
            ...
            <p className="text-gray-400 hand-drawn-text">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        {teamSize}/{team.eventId.maxMembersPerTeam ?? "-"}{" "}
                        members
                      </p>
                    </div>
                      ...
                      {isTeamComplete ? (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className="text-cyan text-sm animate-pulse">
                              💳
                            </span>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        {isPaidEvent && (
                          <div className="col-span-2 rounded-lg border border-gray-700 bg-gray-900/40 p-2">
                            ...
                            {statusConfig ? (
                              <span
                                className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium ${statusConfig.className}`}
                              >
                                {statusConfig.label}
                              </span>
                            ) : (
                          ...
                          <div className="space-y-2">
                            {team.members.map((member) => {
                              ...
                              const viewerIsLeader =
                                !!currentUserId &&
                                !!leaderMember &&
                                leaderMember._id === currentUserId;
                                  ...
                                  {!isThisMemberTheLeader &&
                                    ...
                                    (!team.eventId.isPaidEvent ||
                                      ...
                                      <button
                                        ...
                                        className="text-[10px] font-semibold px-2.5 py-1 rounded-md bg-red-500/10 text-red-400 hover:bg-red-500/20 hover:text-red-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                      >
          ...
          <HandDrawnCard>
            <div className="flex flex-col items-center justify-center py-12 space-y-4">
              ...
              <p className="text-gray-400">Join or create a Team</p>
            </div>
          </HandDrawnCard>
        )}
      </HandDrawnCard>
